import { Box, TextField, Button ,FormControl,InputLabel,Select,MenuItem} from "@material-ui/core";
...
function JobPortalSearchBox() {
  ...
  const [filterDataInput, setFilterDataInput] = React.useState({jobType: "",jobLocation: "", searchData: ""});

  const handleFilterInputDataChange = (event) => {
    setFilterDataInput( pre => ({...pre, [event.target.name]: event.target.value}));
  };
  ...
  return (
    <Box className={classes.searchBox}>
      <TextField id="search" label="Search Jobs" variant="outlined" name="searchData" value={filterDataInput.searchData} onChange={handleFilterInputDataChange}/>
